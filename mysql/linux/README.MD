...
### 启动mysql服务
cd /usr/local/mysql  
./bin/mysqld_safe --user=mysql --init-file=./etc/my.cnf &  
./bin/mysqld --user=mysql --defaults-file=./etc/my.cnf &  

### 修改mysql初始密码
./bin/mysqld_safe --user=mysql  --skip-grant-tables --skip-networking --init-file=./etc/my.cnf &  
use mysql;  
